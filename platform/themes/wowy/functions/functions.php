                ...
                MetaBox::addMetaBox(
                    ...
                    function () {
                        ...
                        if (!empty($args[0])) {
                            ...
                            $expandingProductCategories = MetaBox::getMetaData($args[0],
                                'expanding_product_categories_on_the_homepage', true);
                        }
                        ...
                        return Theme::partial('additional-page-fields',
        ...
        case Page::class:
            ...
            if ($request->has('expanding_product_categories_on_the_homepage')) {
                if ($request->input('expanding_product_categories_on_the_homepage')) {
                    MetaBox::saveMetaBoxData($object, 'expanding_product_categories_on_the_homepage',
